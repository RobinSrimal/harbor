...
mod tests {
    ...
    #[test]
    fn test_known_vector_public_key_derivation() {
        // RFC 8032 Ed25519 test vector seed.
        ...
        let kp = key_pair_from_bytes(&private_key);
        assert_eq!(kp.private_key, private_key);
        assert_eq!(kp.public_key, expected_public_key);
    }
