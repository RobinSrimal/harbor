...
pub use topic::{
    ...
    get_topics_for_member, is_subscribed, is_topic_admin, is_topic_member, remove_topic_member,
    set_topic_members, subscribe_dm_topic, subscribe_topic, subscribe_topic_with_admin,
    unsubscribe_topic,
};
